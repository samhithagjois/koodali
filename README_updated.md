...
- The Person class is going to change as well as the teacher and student classes. Specifications in the model
- The repository classes will (mostly) stay the same
- The service classes will have way more add/update methods
- The controller classes will have more fields 
- 
