...
3. The students have following view : View Pending Assignments | View Submitted Assignments | View Graded Assignments
4. The teachers have following view : Upload Assignment  | View Ungraded Assignments | View Graded Assignments | Student Overview
5. So the workflow is :
    -> Teacher uploads assignment A for class B
    -> all students of class B get A added to their Pending Assignments Tab, and the teacers Student Overview shows "assigned, not read"
    ...
    -> This triggers the teacher's Student Overview, which marks it as "read, not submitted"
